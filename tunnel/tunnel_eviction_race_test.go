...
// tunnel_concurrent_test.go: the post-record stale side-effect
...
// 9. The eviction delete-handler decision must be captured
...
// 10. DeleteTargetHandler for an evicted, fully-registered
